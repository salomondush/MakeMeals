...
| 5       | 2            | <ul> <li> p1: Continue(p1 core features  + ambiguous tech probs) </li> <li>- [x] Search Page </li> <li>- [ ] Find out how to use facebook sharing </li> <li>- [x] Integrate textract to scan recipes  </li> <li>- [x] favorites Page </li> </ul>                                                                                                                                                                                                                                                                                                                                                    |
