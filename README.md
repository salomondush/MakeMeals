...
| 6       | 3            | <ul> <li> p1: Continue (p1 core features + ambiguous tech probs) </li> <li>- [x] Recipe details page </li> <li>- [x] Integrate (https://dynapictures.com/lp/developers) image generation SDK to generate a sharable recipe </li>  <li>- [x] Add recipe sharing feature </li> </ul>                                                                                                                                                                                                                                                                                                                  |
|         | 4            | <ul> <li> p1: Complete (p1 core features + ambiguous tech probs) </li> <li> p2: Start (p2 stretch features + polish) </li> <li>- [x] generate shopping list from recipe </li> <li>- [x] allow user's to save and view shopping lists </li> </ul>                                                                                                                                                                                                                                                                                                                                                    |
